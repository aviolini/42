...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/07/29 17:10:32 by arrigo            #+#    #+#             */
/*   Updated: 2021/07/29 17:14:48 by arrigo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_has_taken_fork(t_data *data, unsigned int c, unsigned int d)
{
	...
	if (pthread_mutex_lock(&data->mutex_print))
		return ((1));
	if (!data->var_death)
		printf(CYN"%u\t%u has taken fork %u\n"DEF, \
